            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.PropertySummary"
                        }
                    },
                    "400": {
        ...
        "/properties/{id}/lease": {
            "post": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "property not found, or tenant not found",
                        "schema": {
                            "$ref": "#/definitions/response.Error"
                        }
                    },
    ...
    "definitions": {
        "entity.Bill": {
            ...
            "properties": {
                "date": {
                    "type": "string",
                    "example": "2026-06-25T14:00:00.000Z"
                },
                "due_date": {
                    "type": "string",
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.BillItem"
                    }
                },
                "property_id": {
                    "type": "string",
        ...
        "entity.PropertyDetail": {
            "description": "Объект недвижимости с автоматически собранными связанными сущностями: показаниями счетчиков, счетами, будущими начислениями, данными аренды и арендодателя.",
            "type": "object",
            "properties": {
                "apartment": {
                    "type": "string",
                ...
                "customNextItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.CustomNextItem"
                    }
                },
                "el1_tariff": {
                    "type": "number",
                ...
                "readings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.Reading"
                    }
                },
                "region": {
                    "type": "string",
