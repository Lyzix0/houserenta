...
type Register struct {
	...
	Document    string  `json:"document,omitempty" example:"4510 123456"`
...
type Login struct {
	Email    string `json:"email" validate:"required" example:"ivan.petrov@example.com"`
...
type Profile struct {
	...
	Document    *string `json:"document,omitempty" example:"4510 123456"`
	Phone       *string `json:"phone,omitempty" example:"+79997776655"`
	...
	Password    *string `json:"password,omitempty" validate:"omitempty,min=6" example:"newSuperSecurePassword"`
}
